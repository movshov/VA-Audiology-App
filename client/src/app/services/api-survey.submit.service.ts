...
export class SurveySubmitHandler {
  ...
  public buildPatientSurveyJSON(testData, thsScoreVars: Map<string, number>, tfiVars: Map<string, number>, tsType: string): PatientSurveyJSON {
  ...
  public buildRecommendedTestJsonPropertiesFromTestsData(storeIn: PatientSurveyJSON, testData): boolean {
    if (testData === null) {
      return false;
    }
  ...
  public buildPatientJSON(): PatientJSON {
  ...
  public buildTfiJsonValues(storeIn: PatientSurveyJSON, tfiVars: Map<string, number>): boolean {
    if (tfiVars === null) {
      return false;
    }
  ...
  public buildFreqConfig(testData, configType: string): string {
    let result: string = '';
  ...
  public getPropertyValue(testData, property: string): string {
